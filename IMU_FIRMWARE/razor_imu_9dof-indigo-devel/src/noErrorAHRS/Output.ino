...
{
  String data = "";
  String y = String(TO_DEG(yaw));
  String p = String(TO_DEG(pitch));
  String r = String(TO_DEG(roll));
//  LOG_PORT.print("#YPR=");
//  LOG_PORT.print(TO_DEG(yaw)); LOG_PORT.print(",");
//  LOG_PORT.print(TO_DEG(pitch)); LOG_PORT.print(",");
//  LOG_PORT.print(TO_DEG(roll)); LOG_PORT.print("Hey\n");
...
bool sdLogString(String toLog)
{
  ...
  File logFile = SD.open("2.txt", FILE_WRITE);
