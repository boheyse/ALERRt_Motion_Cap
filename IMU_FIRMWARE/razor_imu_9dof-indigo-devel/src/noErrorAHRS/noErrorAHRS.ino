...
float magn_ellipsoid_center[3] = {347.048, -434.258, -354.821};
float magn_ellipsoid_transform[3][3] = {{0.990467, -0.0190028, -0.0149897}, {-0.0190028, 0.917453, 0.0324934}, {-0.0149897, 0.0324934, 0.889338}};
...
// This function controls all aspects of communicating with the mobile device over a bluetooth connection
void readSerial(){
