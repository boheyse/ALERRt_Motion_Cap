...
float magn_ellipsoid_center[3] = {443.807, -286.653, -76.155};
float magn_ellipsoid_transform[3][3] = {{0.9873103, -0.01228721, 0.003443767}, {-0.01228721, 0.984704333, 0.003891453}, {0.003443767, 0.003891453, 0.968212}};
...
void loop()
{
  while(Serial1.available())
  {
    ...
    if(tsfr){
      ...
      Serial1.println("No SD Card Installed");
      if (dataFile) 
      {
