...
float magn_ellipsoid_center[3] = {181.382, -143.387, -104.920};
float magn_ellipsoid_transform[3][3] = {{0.962467, 0.0307328, 0.0383603}, {0.0307328, 0.971465, -0.0261049}, {0.0383603, -0.0261049, 0.952445}};
...
void CheckBatLevel(void)
{
  ...
  Serial1.print("BattC:" + String(LipoV));
}
...
void loop()
{
  while(Serial1.available())
  {
    ...
    if(toSend == start)
    {
      ...
      Serial1.println("Recording Started");
      while(runn)
      {
